...
<%-- header,footer 전용 CSS / font CSS --%>
<link rel="stylesheet" href="<%= ctxPath %>/css/jy/header_revised.css" type="text/css">
<link rel="stylesheet" href="<%= ctxPath %>/css/font.css" type="text/css">
 ...
 <body id="container" style="overflow-x:hidden;">
	...
	<nav class="navbar navbar-expand-lg bg-white navbar-white sticky-top ">	
		<a class="logo-svg" href="<%=ctxPath%>/main.tam">
		  <svg class="logo-svg" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="150" height="18.562" viewBox="0 0 150 18.562" style="padding:0; margin:0;">
		        <defs>
	...
	<%-- 사이드바 시작 --%>
		...
		<span>
			<a class="nav-link header_footer_font" href="<%= ctxPath%>/cart_detail.tam">
				<svg xmlns="http://www.w3.org/2000/svg" height="18px" viewBox="0 0 448 512"><style>svg{fill:#000000}</style>
		...
		<div class="side_bar">	
			<div id="mySidepanel" class="sidepanel">
				...
				<a href="<%=ctxPath%>/index.tam">제품 보기</a>
				
				<ul>
					<li><a href="<%=ctxPath%>/index.tam">신제품 보기</a></li>
					<li><a href="<%=ctxPath%>/store/storeMain.tam">매장 보기</a></li>			 
				</ul>
				...
				<ul>
					<li><a href="<%=ctxPath%>/mypage/mypage.tam">마이페이지</a></li>
					<li>
