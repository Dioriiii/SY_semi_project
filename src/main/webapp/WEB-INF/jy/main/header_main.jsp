...
<link rel="stylesheet" href="<%= ctxPath %>/css/jy/main/header_main.css" type="text/css">
...
<link rel="icon" href="<%= ctxPath%>/images/jy/fav_tamburins.png">
  ...
  <body id="container" style="overflow: scroll; overflow-x:hidden">
	  
	<%-- 네비게이션바 시작 --%>  
	<div id="nav_wrap">
	<nav class="navbar navbar-expand-lg bg-transparent navbar-white sticky-top ">
	  <a class="logo-svg" href="<%=ctxPath%>/index.tam">
	...
	<%-- 사이드바 시작 --%>
		...
		<span>
			<a class="nav-link header_footer_font" href="#">
				<svg xmlns="http://www.w3.org/2000/svg" height="1.5em" viewBox="0 0 448 512"><style>svg{fill:#000000}</style>
		...
		<div class="side_bar">	
			<div id="mySidepanel" class="sidepanel">
			  ...
			  <a href="<%=ctxPath%>/index.tam">전체 보기</a>
			  <a href="<%=ctxPath%>/store/storeMain.tam">매장 보기</a>
